...
const Navbar = () => {
  ...
  return (
    <motion.nav 
      ...
      className={`flex items-center justify-between px-6 md:px-12 lg:px-24 py-4 sticky top-0 z-50 transition-all duration-300 ${
    ...
    >
      <div className="flex items-center gap-8">
        <div className="flex items-center gap-2 cursor-pointer group">
          ...
          <span className="hidden sm:block text-2xl font-light text-gray-300">|</span>
          <span className="hidden sm:block text-lg md:text-xl font-medium text-gray-600">Servicios Pro</span>
        </div>
      ...
      <div className="flex items-center gap-2 md:gap-4">
        <button className="hidden md:block p-2 text-brand-red hover:bg-red-50 rounded-full transition-colors border border-transparent hover:border-red-100">
          <Search size={20} />
        </button>
        ...
        >
          <User size={18} />
          <span className="hidden xs:block">Acceder</span>
        </motion.button>
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div
            ...
            className="absolute top-full left-0 w-full bg-white border-b border-gray-100 lg:hidden overflow-hidden shadow-xl"
          >
            <div className="flex flex-col p-6 gap-4">
              ...
              <div className="flex items-center justify-between pt-4">
                ...
                <button className="p-2 text-brand-red border border-red-100 rounded-full">
                  <Search size={20} />
                </button>
              </div>
            </div>
